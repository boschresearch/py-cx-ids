...
#   timestamp: 2023-12-15T21:59:24+00:00
...
class OdrlConstraint(MyBaseModel):
    odrl_left_operand: Optional[OdrlOperand] = Field(None, alias='odrl:leftOperand')
    odrl_right_operand: Optional[OdrlOperand] = Field(None, alias='odrl:rightOperand')
...
class OdrlRule(MyBaseModel):
    ...
    odrl_constraint: Optional[OdrlConstraint] = Field(None, alias='odrl:constraint')
    odrl_duty: Optional[List[str]] = Field(None, alias='odrl:duty')


class OdrlPolicy(MyBaseModel):
    field_id: Optional[str] = Field(None, alias='@id')
    field_type: Optional[str] = Field('odrl:Policy', alias='@type')
    odrl_permission: Optional[
        Union[OdrlRule, List[OdrlRule], OdrlLogicalConstraint]
    ] = Field(None, alias='odrl:permission')
    odrl_prohibition: Optional[
        Union[OdrlRule, List[OdrlRule], OdrlLogicalConstraint]
    ] = Field(None, alias='odrl:prohibition')
    odrl_obligation: Optional[
        Union[OdrlRule, List[OdrlRule], OdrlLogicalConstraint]
    ] = Field(None, alias='odrl:obligation')
