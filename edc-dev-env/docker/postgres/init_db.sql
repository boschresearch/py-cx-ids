...
CREATE DATABASE "edc_provider_edrs";
...
CREATE DATABASE "edc_consumer_edrs";

CREATE DATABASE "edc_third_asset";
CREATE DATABASE "edc_third_contractdefinition";
CREATE DATABASE "edc_third_contractnegotiation";
CREATE DATABASE "edc_third_policy";
CREATE DATABASE "edc_third_transferprocess";
CREATE DATABASE "edc_third_edrs";
